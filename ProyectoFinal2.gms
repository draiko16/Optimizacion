...
Alias (cd, cd2);
Table encdcd(cd, cd2) "Costos de envios entre los CD ($/Kg)"
        cd1     cd2
    cd1 0       20.3
    cd2 19.5    0   ;
...
Variables
    ...
    x2(cd, pr, cd2) "Envios entre los CD"
...
*Sumatoria de los costos de envios entre los CD
                -sum((cd,cd2), sum(pr, x2(cd, pr,cd2)*encdcd(cd, cd2)))
...
Display reqIn.l, x.l, x2.l, y.l, Z.l;
